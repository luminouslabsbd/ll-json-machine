...
for PHP >=8.0. See [TL;DR](#tl-dr). No dependencies in production except optional `ext-json`.
...
`Inspired from` : https://github.com/halaxa/json-machine/tree/master#guzzlehttp
